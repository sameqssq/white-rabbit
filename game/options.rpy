...
define config.name = _("WHITE RABBIT")
...
define gui.about = _p("""
Un aspirante de la unidad de Análisis e Investigación Forense es seleccionado como Biohacker para sincronizar su consciencia con la de agentes involucrados en atentados terroristas en distintos bucles temporales a fin de recabar toda la información posible para impedir que los eventos catastróficos ocurran. Sin embargo, en su primer viaje, pequeñas coincidencias y recuerdos alterarán su estabilidad mental, llevándolo a dudar de su verdadera participación en la misión.
""")
...
define build.name = "white-rabbit"
...
define config.save_directory = "jam-1723258492"
