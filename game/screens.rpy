...
style window:
    ...
    background Image("gui/textbox3.png", xalign=0.5, yalign=1.0)
    ...
    use game_menu(_("Acerca de"), scroll="viewport"):
        ...
        vbox:
            ...
            vbox:
                xpos 50
                text "Concepto:"
                text "Camila Miranda, Carolina Saavedra y Cristina Miranda"
            vbox:
                xpos 50
                text "Historia:"
                text "Camila Miranda"
            vbox:
                xpos 50
                text "Programación:"
                text "Carolina Saavedra"
            vbox:
                xpos 50
                text "Arte y Diseño:"
                text "Cristina Miranda"
...
style about_text is gui_text:
    font "gui/fonts/UbuntuCondensed-Regular.ttf"
...
style confirm_frame:
    background Frame([ "gui/confirm_frame.png", "images/frame3.png"], gui.confirm_frame_borders, tile=gui.frame_tile)
